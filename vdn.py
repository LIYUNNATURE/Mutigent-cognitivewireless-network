...
class VDN:
    def __init__(self, args):
        ...
        if self.args.load_model:
            if os.path.exists(self.model_dir + '/_rnn_net_params.pkl'):
                path_rnn = self.model_dir + '/_rnn_net_params.pkl'
                path_vdn = self.model_dir + '/_vdn_net_params.pkl'
    ...
    def learn(self, batch, max_episode_len, train_step, epsilon=None):  # train_step表示是第几次学习，用来控制更新target_net网络的参数
        '''
        在learn的时候，抽取到的数据是四维的，四个维度分别为 2—1——第几个episode —episode中第几个transition
        ...
        u, r, avail_u, avail_u_next = batch['u'], batch['r'],  batch['avail_u'], \
                                                  batch['avail_u_next']
    ...
    def save_model(self, train_step):
        ...
        torch.save(self.eval_vdn_net.state_dict(), self.model_dir  + '/_vdn_net_params.pkl')
        torch.save(self.eval_rnn.state_dict(),  self.model_dir  + '/_rnn_net_params.pkl')
